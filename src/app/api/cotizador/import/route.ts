...
- TOUR: extrae CADA tour o actividad como su propio item TOUR. "name"=nombre del tour, "location"=lugar, "date"=fecha, "duration"=duración OBLIGATORIO — si no aparece explícita, ESTÍMALA según el tipo de actividad usando tu conocimiento (visita panorámica de ciudad → "3 horas"; excursión a sitio histórico → "Día completo"; traslado nocturno/show → "2-3 horas"; city tour → "4 horas"; tour medio día → "Medio día"; nunca dejes este campo vacío), "language"=idioma del tour — si no se menciona, infiere según el destino: países hispanohablantes → "Español"; destinos europeos no hispanohablantes en paquetes turísticos → "Español e Inglés"; otros → "Inglés", "includes"=lista de servicios incluidos separados por · SIN entradas (ej: "Guía · Transporte · Seguro"), "meals"=si incluye comida o no (ej: "Almuerzo incluido", "Desayuno y almuerzo incluidos", "No incluye comidas"), "entrances"=array de entradas/tickets mencionados, cada uno con "name" (nombre del lugar), "included" (true si la entrada está incluida en el precio, false si tiene costo extra), "price" (costo extra si no está incluida, ej: "$25 USD", o "" si está incluida), "description"=descripción detallada de las actividades y experiencias del tour (2-4 oraciones), "price"=precio total del tour.
