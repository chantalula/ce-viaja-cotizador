...
- HOTEL: "name"=nombre exacto del hotel, "location"=ciudad y país (ej: "Cancún, México"), "checkIn"/"checkOut"=fechas en español corto, "nights"=número de noches como texto, "roomType"=tipo de habitación (ej: "Habitación Doble Estándar", "Suite Junior"), "board"=régimen de comidas (ej: "Todo Incluido", "Solo Desayuno", "Solo Alojamiento"), "price"=precio TOTAL de la estadía completa (no por noche). Si el documento muestra precio por noche, multiplícalo por el número de noches. Si muestra precio por habitación o por persona, usa ese total. Busca cualquier valor que diga "total", "precio", "rate", "importe", "amount" o similar.
