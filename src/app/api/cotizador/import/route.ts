...
HOTEL: {"type":"hotel","name":"","location":"","address":"","checkIn":"","checkOut":"","nights":"","roomType":"","board":"","cancellation":"","price":0}
...
- HOTEL: "name"=nombre exacto del hotel, "location"=ciudad y país (ej: "Cancún, México"), "address"=dirección física del hotel. Si no aparece en el documento, usa tu propio conocimiento para completarla (ej: "Blvd. Kukulcán Km 9.5, Zona Hotelera, Cancún"). Siempre intenta llenar este campo. "checkIn"/"checkOut"=fechas en español corto, "nights"=número de noches como texto, "roomType"=tipo de habitación (ej: "Habitación Doble Estándar", "Suite Junior"), "board"=régimen de comidas (ej: "Todo Incluido", "Solo Desayuno", "Solo Alojamiento"), "cancellation"=política o términos de cancelación si aparecen en el documento, "price"=precio TOTAL de la estadía completa (no por noche). Si el documento muestra precio por noche, multiplícalo por el número de noches. Si muestra precio por habitación o por persona, usa ese total. Busca cualquier valor que diga "total", "precio", "rate", "importe", "amount" o similar.
- CARRO: "category"=clase del vehículo (ej: "Intermediate SUV"), "model"=nombre del modelo (ej: "Mazda CX-50 o similar"), "pickupLocation"/"dropoffLocation"=lugar de recogida/devolución, "days"=número de días como texto, "passengers"/"bags"/"doors"=números como texto, "ac"="Sí"/"No", "transmission"="Automático"/"Manual", "protection"=tipo de protección, "promotion"=texto de promoción, "price"=precio total.
