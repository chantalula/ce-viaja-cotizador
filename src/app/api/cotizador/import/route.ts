...
TOUR: {"type":"tour","name":"","location":"","date":"","duration":"","includes":"","description":"","price":0}
...
- TOUR: extrae CADA tour o actividad como su propio item TOUR. "name"=nombre del tour, "location"=lugar, "date"=fecha, "duration"=duración estimada (ej: "8 horas", "Medio día", "Día completo"), "includes"=lista de lo que incluye separado por · (ej: "Guía · Transporte · Entradas · Almuerzo"), "description"=descripción detallada de las actividades y experiencias del tour (2-4 oraciones, extraída del documento o generada con tu conocimiento del destino), "price"=precio.
